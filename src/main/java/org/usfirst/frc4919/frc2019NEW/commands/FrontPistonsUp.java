...
*
*/
public class FrontPistonsUp extends Command {

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
    private final DoubleSolenoid doubleSolenoid = Pneumatics.frontPistons;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public FrontPistonsUp() {
    ...
    @Override
    protected void end() {
        System.out.println("Front Pistons retracted");
    }
